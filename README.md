...
## Home Page
### For the home page i wanted it to be easy to see that you can click the boxes to read the full article so i used shadowboxing witch i got via [getcssscan](https://getcssscan.com/css-box-shadow-examples)
